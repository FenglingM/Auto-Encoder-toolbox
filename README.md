...
@inproceedings{mao2017stochastic, </br>
  &emsp title={Stochastic decorrelation constraint regularized auto-encoder for visual recognition},</br>
  &emsp author={Mao, Fengling and Xiong, Wei and Du, Bo and Zhang, Lefei},</br>
  &emsp booktitle={International Conference on Multimedia Modeling, </br>
  &emsp pages={368--380, </br>
  &emsp year={2017},</br>
